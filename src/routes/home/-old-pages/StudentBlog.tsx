...
const StudentBlog = () => {
  ...
  const articles = [
    // Canada Articles
    {
      id: 1,
      country: "Canada",
      title: "What to Know Before Studying in Canada as a Student",
      date: "Jun 15, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 2,
      country: "Canada",
    ...
    },
    {
      id: 3,
      country: "Canada",
      title: "Visa Process Simplified for Canada Immigration",
      date: "Jun 05, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 4,
      country: "Canada",
      title: "Living Costs in Canada: A Student Guide",
      date: "Jun 01, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 5,
      country: "Canada",
      title: "Scholarships Available for Canadian Studies",
      date: "May 28, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 6,
      country: "Canada",
      title: "Cultural Adaptation Tips for Canada",
      date: "May 20, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    ...
    // United States Articles
    {
      ...
      title: "Best US Colleges for Engineering",
      date: "Jun 14, 2025",
      image:
    ...
    },
    {
      id: 8,
      country: "United States",
      title: "Understanding US Student Visa Requirements",
      date: "Jun 12, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750803402/feshia%20Images/images_6_1_qksjbu.png",
    },
    {
      id: 9,
      country: "United States",
      title: "Life as an International Student in the US",
      date: "Jun 08, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750803402/feshia%20Images/images_6_1_qksjbu.png",
    },
    ...
    // United Kingdom Articles
    {
      ...
      title: "Top UK Universities for Business Studies",
      date: "Jun 13, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 11,
      country: "United Kingdom",
      title: "UK Immigration Rules for Students",
      date: "Jun 09, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    {
      id: 12,
      country: "United Kingdom",
      title: "Exploring London as a Student",
      date: "Jun 04, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    ...
    // Australia Articles
    {
      id: 13,
      country: "Australia",
      title: "Study Opportunities in Australian Universities",
      date: "Jun 16, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
    ...
    },
    {
      id: 15,
      country: "Australia",
      title: "Living in Sydney: Student Life",
      date: "Jun 07, 2025",
      image:
        "https://res.cloudinary.com/greenmouse-tech/image/upload/v1750962359/feshia%20Images/1_1_ub0w25.jpg",
    },
  ...
  const filteredArticles =
    activeTab === "all"
      ...
      : articles.filter(
          (article) =>
            article.country.toLowerCase() === activeTab.toLowerCase(),
        );
        ...
        <div className="Resizer bg-white ">
          <div className="max-w-3xl text-center mx-auto mb-10">
            ...
            <p className="text-black mb-6">
              ...
              possibilities from universities worldwide, empowering them to
              shape their future through knowledge and exploration.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredArticles.map((article) => (
              <div
                key={article.id}
                className="bg-[#F6F6F6] p-2 rounded-lg overflow-hidden"
              >
                <img
                  src={article.image}
                  alt={article.title}
                ...
                <div className="p-2">
                  ...
                  <p className="text-base mt-10 text-gray-500">
                    {article.date}
                  </p>
                </div>
              </div>
