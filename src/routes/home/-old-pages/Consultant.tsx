            ...
            <div className="w-full md:w-1/2  rounded-lg space-y-6">
              <div className="rounded-lg bg-[#E6E6E6] p-6">
                ...
                <p className="flex items-center mb-2">
                  <MapPin className="text-black mr-2 w-5 h-5" />7 Ikorodu Road,
                  Maryland Behind Maryland BRT Bus Stop Maryland Lagos - Nigeria
                </p>
                <p className="flex items-center mb-2">
                  <Phone className="text-black mr-2 w-5 h-5" />
                  +234 901 994 7067
                </p>
                <p className="flex items-center mb-2">
                  <Mail className="text-black mr-2 w-5 h-5" />
              ...
              <div className="rounded-lg bg-[#E6E6E6] p-6">
                ...
                <p className="flex items-center mb-2">
                  <Building2 className="text-black mr-2 w-5 h-5" />
